...
fn test_sniff_atom_feed_with_no_sniff_flag_on() {
    test_sniff_parametrable_flags(&PathBuf::from("text/xml/feed.atom"), "text", "html", Some(("text", "html")), MIMENoSniffFlag::ON, MIMEApacheBugFlag::OFF);
}

#[test]
fn test_sniff_with_no_sniff_flag_on_and_apache_flag_on() {
    test_sniff_parametrable_flags(&PathBuf::from("text/xml/feed.atom"), "text", "html", Some(("text", "html")), MIMENoSniffFlag::ON, MIMEApacheBugFlag::ON);
}

#[test]
fn test_sniff_utf_8_bom_with_apache_flag_on() {
    test_sniff_parametrable_flags(&PathBuf::from("text/plain/utf8bom.txt"), "text", "plain", None, MIMENoSniffFlag::OFF, MIMEApacheBugFlag::ON);
}

#[test]
fn test_sniff_utf_16be_bom_with_apache_flag_on() {
    test_sniff_parametrable_flags(&PathBuf::from("text/plain/utf16bebom.txt"), "text", "plain", None, MIMENoSniffFlag::OFF, MIMEApacheBugFlag::ON);
}

#[test]
fn test_sniff_utf_16le_bom_with_apache_flag_on() {
    test_sniff_parametrable_flags(&PathBuf::from("text/plain/utf16lebom.txt"), "text", "plain", None, MIMENoSniffFlag::OFF, MIMEApacheBugFlag::ON);
}

#[test]
fn test_sniff_octet_stream_apache_flag_on() {
    test_sniff_parametrable_flags(&PathBuf::from("unknown/binary_file"), "application", "octet-stream", None, MIMENoSniffFlag::OFF, MIMEApacheBugFlag::ON);
}
