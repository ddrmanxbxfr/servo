...
use mime_classifier::MIMEApacheBugFlag;
use mime_classifier::MIMENoSniffFlag;
...
pub fn start_sending_sniffed_opt(start_chan: LoadConsumer, mut metadata: Metadata,
    ...
    if opts::get().sniff_mime_types {
        ...
        let mut no_sniff: MIMENoSniffFlag = MIMENoSniffFlag::OFF;
        let mut check_for_apache_bug: MIMEApacheBugFlag = MIMEApacheBugFlag::OFF;
...
fn apache_bug_predicate(last_raw_content_type: &Vec<u8>) -> MIMEApacheBugFlag {
